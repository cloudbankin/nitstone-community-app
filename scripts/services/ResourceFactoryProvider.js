        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    manualChargeResource: defineResource(apiVer + "/loans/:loanId/charges/manualcharges", {loanId: '@loanId'}, {
                        put: {method: 'PUT', params: {}}
                    }),
                    ...
                    getAccountDescResource: defineResource(apiVer + "/loans/getAccountDesc/:paymentId/:loanId", {paymentId: '@paymentId', loanId: '@loanId'}, {
                        get: {method: 'GET', params: {}}
                    }),
                    ...
                    getClosingBalDbCrResource: defineResource(apiVer + "/journalentries/:accountId/:officeId/:transactionDate/:hierarchy", {accountId: '@accountId', officeId: '@officeId',  hierarchy: '@hierarchy', transactionDate: '@transactionDate'}, {
                        get: {method: 'GET', params: {}}
                    }),
                    ...
                    holidayResource: defineResource(apiVer + "/holidays/allActiveHolidays", {}, {
                        getAllActiveHols: {method: 'GET', params: {}, isArray: true}
                    }),
                    ...
                    jointBorrowerResource: defineResource(apiVer + "/loans/:loanId/borrower/:templateResource", {loanId: '@loanId', templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        update: {method: 'PUT', params: {}},
                  ...
                  //Habile changes for tax component
                    ...
                    verifyLinkResource: defineResource(apiVer + "/forgotPassword/resetLink/:username", {username: '@username'}, {
                        get: {method: 'GET', params: {}}
                    }),
                    getResetPassword: defineResource(apiVer + "/forgotPassword/reset/:token", {token: '@token'}, {
                        get: {method: 'GET', params: {}}
                    }),
