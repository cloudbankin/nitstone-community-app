(function (mifosX) {
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/loanmanualcharge/:id/paymanualcharge/:chargeId/:amount', {
                templateUrl: 'views/loans/paymanualcharge.html'
            })
            ...
            .when('/addmanualcharge/:id', {
                templateUrl: 'views/loans/addmanualcharge.html'
            })
            ...
            .when('/viewtransactions/:transactionId/:isEntry', {
                templateUrl: 'views/accounting/view_transactions.html'
            })
            .when('/journalentry', {
            ...
            .when('/jointBorrower/:id', {
                templateUrl: 'views/loans/jointBorrower.html'
            })
            .when('/listjointBorrower/:id', {
                templateUrl: 'views/loans/list_jointBorrower.html'
            })
